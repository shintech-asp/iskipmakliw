...
namespace iskipmakliw.Migrations
{
    ...
    [Migration("20260311065415_ImplementingCustomizationFor3d")]
    partial class ImplementingCustomizationFor3d
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iskipmakliw.Models.CustomizationChat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CustomizationOrdersId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CustomizationOrdersId");

                    b.HasIndex("SellersId");

                    b.HasIndex("UsersId");

                    b.ToTable("CustomizationChat");
                });
            ...
            modelBuilder.Entity("iskipmakliw.Models.DeliverProduct", b =>
                {
                    ...
                    b.Property<DateTime?>("RemittedOn")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("iskipmakliw.Models.ProductModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("iskipmakliw.Models.Terms", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("iskipmakliw.Models.CustomizationChat", b =>
                {
                    b.HasOne("iskipmakliw.Models.CustomizationOrders", "CustomizationOrders")
                        .WithMany("CustomizationChat")
                        .HasForeignKey("CustomizationOrdersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
